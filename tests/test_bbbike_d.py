"""
Test the :py:class:`pydriosm.downloader.bbbike.BBBikeDownloader` class.
"""
...
import pandas as pd
import pytest
from pydriosm.downloader.bbbike import BBBikeDownloader
...
class TestBBBikeDownloader:
    ...
    def test_get_names_of_cities(self, bbd, update):
    ...
    @pytest.mark.parametrize('update', [True, False])
    def test_get_coordinates_of_cities(self, bbd, update):
    ...
    @pytest.mark.parametrize('update', [True, False])
    def test_get_subregion_index(self, bbd, update):
        subrgn_idx = bbd.get_subregion_index(update=update, confirmation_required=False, verbose=True)
    ...
    def test_validate_file_format(self, bbd):
    ...
    def test_download_osm_data(self, bbd):
        subrgn_name = 'London'
        file_format = "pbf"
